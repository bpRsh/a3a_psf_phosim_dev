...
#               Changed magnitude of psf0 to 1.5 smaller to make pixels of psf0
#               brighter. (initially psf20 pixels were 4 times higher than psf0)
...
"""
    ...
    # psf0 has 4 times less count than psf20, so increase mag by 1.5
    outfile = outfolder + '/' + 'narrowband0.icat'
    print('{} {} {}'.format('creating: ',outfile, ''))
    
    with open(outfile,'w') as fout:
        fout.write(data.lstrip())
        
        # sed is relative to ~/phosim/data/seds 
        # NOTE: ../../../ is home
        sed  = '../../../Research/extreme_red_blue_psf/seds/narrowband0.sed'
        line = r'object 0 0.0 0.0 22.5 '+ sed + \
    ...
    # psf20
    outfile = outfolder + '/' + 'narrowband20.icat'
    print('{} {} {}'.format('creating: ',outfile, ''))
    ...
    with open(outfile,'w') as fout:
        ...
        # sed is relative to ~/phosim/data/seds 
        # NOTE: ../../../ is home
        sed  = '../../../Research/extreme_red_blue_psf/seds/narrowband20.sed'
        line = r'object 0 0.0 0.0 24 '+ sed + \
               r' 0 0 0 0 0 0 star none none' + '\n'
