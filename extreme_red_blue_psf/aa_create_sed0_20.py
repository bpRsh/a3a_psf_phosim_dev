...
# Inputs     : sed_flat.txt
# Outputs    : seds/narrowband0.sed_and_narrowband20.sed

# Info:
# 1. This program takes in  input_sed_file (sed_flat.txt)
#    and creates two   output_sed files.
#
...
def main():
    ...
    # create sed file for narrowband0
    outfile = outfolder + '/' + 'narrowband0.sed'
    lower = line_num[0]
    upper = line_num[1]
    ...
    # create sed file for narrowband20
    outfile = outfolder + '/' + 'narrowband20.sed'
    lower = line_num[20]
    upper = line_num[21] + 1
